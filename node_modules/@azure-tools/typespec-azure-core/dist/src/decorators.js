 ...
 */
export function $useFinalStateVia(context, entity, finalState) {
    const { program } = context;
    let finalStateVia;
...
/** @internal */
export function $armResourceIdentifierConfig(context, entity, config) {
...
export function $defaultFinalStateVia(context, target, states) {
    const { program } = context;
