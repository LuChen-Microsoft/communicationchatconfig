import { DecoratorContext, Diagnostic, Enum, EnumMember, IntrinsicType, Model, ModelProperty, Operation, Program, Scalar, StringLiteral, Type, Union, UnionVariant } from "@typespec/compiler";
...
export declare function $lroStatus(context: DecoratorContext, entity: Enum | Union | ModelProperty): void;
...
export declare function $lroSucceeded(context: DecoratorContext, entity: EnumMember | UnionVariant): void;
/**
...
export declare function $lroCanceled(context: DecoratorContext, entity: EnumMember | UnionVariant): void;
/**
...
export declare function $lroFailed(context: DecoratorContext, entity: EnumMember | UnionVariant): void;
/**
 ...
 */
export declare function $useFinalStateVia(context: DecoratorContext, entity: Operation, finalState: string): void;
...
export declare function $defaultFinalStateVia(context: DecoratorContext, target: Operation, states: LroHeader[]): void;
export {};
