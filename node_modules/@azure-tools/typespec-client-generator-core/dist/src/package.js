...
import { getAccess, listClients, listOperationGroups, listOperationsInOperationGroup, } from "./decorators.js";
...
import { createGeneratedName, filterApiVersionsWithDecorators, getAllResponseBodiesAndNonBodyExists, getAvailableApiVersions, getClientNamespaceStringHelper, getDocHelper, getHashForType, getLocationOfOperation, getSdkTypeBaseHelper, isNeverOrVoidType, updateWithApiVersionInformation, } from "./internal-utils.js";
import { createDiagnostic } from "./lib.js";
import { getClientNamespaceString, getCrossLanguageDefinitionId, getCrossLanguagePackageId, getDefaultApiVersion, getEffectivePayloadType, getHttpOperationWithCache, getLibraryName, } from "./public-utils.js";
import { getAllModelsWithDiagnostics, getClientTypeWithDiagnostics, getSdkCredentialParameter, getSdkModelPropertyType, } from "./types.js";
...
function getSdkBasicServiceMethod(context, operation) {
    ...
    // body parameters
    if (parameters.body?.bodyKind !== "multipart" &&
        parameters.body?.property &&
        !isNeverOrVoidType(parameters.body.property.type)) {
        methodParameters.push(diagnostics.pipe(getSdkMethodParameter(context, parameters.body?.property, operation)));
    }
