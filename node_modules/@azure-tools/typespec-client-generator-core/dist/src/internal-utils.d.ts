import { BooleanLiteral, Diagnostic, Interface, Model, Namespace, NumericLiteral, Operation, Program, ProjectedProgram, StringLiteral, Type, Union } from "@typespec/compiler";
import { HttpOperation, HttpStatusCodeRange } from "@typespec/http";
import { SdkBuiltInKinds, SdkBuiltInType, SdkClient, SdkEnumType, SdkHttpResponse, SdkModelPropertyType, SdkModelType, SdkParameter, SdkType, SdkUnionType } from "./interfaces.js";
/**
 *
 ...
 * @param type
 */
export declare function getSdkTypeBaseHelper<TKind>(context: TCGCContext, type: Type, kind: TKind): DefaultSdkTypeBase<TKind>;
...
export declare function createTCGCContext(program: Program): TCGCContext;
...
export declare function getAnyType(): SdkBuiltInType;
export {};
