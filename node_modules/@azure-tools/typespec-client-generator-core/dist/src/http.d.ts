...
import { SdkHttpOperation, SdkHttpParameter, SdkMethodParameter, SdkModelPropertyType, SdkParameter } from "./interfaces.js";
...
export declare function getSdkHttpParameter(context: TCGCContext, type: ModelProperty, operation?: Operation, location?: "path" | "query" | "header" | "body"): [SdkHttpParameter, readonly Diagnostic[]];
