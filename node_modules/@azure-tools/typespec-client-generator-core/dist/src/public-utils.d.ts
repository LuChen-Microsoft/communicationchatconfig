...
import { TCGCContext, TspLiteralType } from "./internal-utils.js";
/**
 ...
 * @returns
 */
export declare function getCrossLanguageDefinitionId(context: TCGCContext, type: Union | Model | Enum | Scalar | ModelProperty | Operation | Namespace | Interface, appendNamespace?: boolean): string;
/**
 ...
 */
export declare function isErrorOrChildOfError(context: TCGCContext, model: Model): boolean;
