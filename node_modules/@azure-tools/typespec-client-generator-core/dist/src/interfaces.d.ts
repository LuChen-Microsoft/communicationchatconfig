...
import { DateTimeKnownEncoding, Diagnostic, DurationKnownEncoding, EmitContext, Interface, ModelProperty, Namespace, Operation, Type } from "@typespec/compiler";
...
declare enum SdkFloatKindsEnum {
    float = "float",
    float32 = "float32",
    float64 = "float64",
    decimal = "decimal",
...
declare enum SdkAzureBuiltInStringKindsEnum {
    uuid = "uuid",
...
declare enum SdkGenericBuiltInStringKindsEnum {
    string = "string",
    password = "password",
    guid = "guid",
    url = "url",
...
declare enum SdkBuiltInKindsMiscellaneousEnum {
    bytes = "bytes",
    boolean = "boolean",
    plainDate = "plainDate",
    plainTime = "plainTime",
...
export type SdkBuiltInKinds = keyof typeof SdkBuiltInKindsMiscellaneousEnum | keyof typeof SdkIntKindsEnum | keyof typeof SdkFloatKindsEnum | keyof typeof SdkGenericBuiltInStringKindsEnum | keyof typeof SdkAzureBuiltInStringKindsEnum;
...
export declare function isSdkFloatKind(kind: string): kind is keyof typeof SdkFloatKindsEnum;
